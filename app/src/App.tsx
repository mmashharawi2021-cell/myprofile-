...
const imagePath = (imageNo: string) => `${base}assets/projects/${imageNo}.png`;
...
// لتبديل الصور يدويًا غيّر imageNo فقط. الصور موجودة هنا: app/public/assets/projects/01.png ... 14.png
